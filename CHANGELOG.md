...
- 修复 Vibe Coding 训练场题目卡片在中等宽度下被三列栅格压坏的问题，改为更宽的双列/整行展示
- 修复 Vibe Coding 题目与评分示例不跟随中英文切换的问题，前后端统一透传并约束 locale
- 重写 Vibe Coding 出题提示词，要求输出真实工程工单式练习题，避免抽象 checklist 和“写 prompt 的 prompt”元题
- 清理 Vibe Coding 训练场残留中英混排文案，补齐流式状态文案的英文翻译并统一标题本地化
