    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800 sm:p-6">
      <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 dark:border-slate-700 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <div className="flex items-center gap-2 text-base font-semibold text-slate-900 dark:text-white">
            <Wand2 className="h-4 w-4 text-klein-500" />
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {activeSession && (
            <a
              ...
              className="inline-flex min-h-[44px] cursor-pointer items-center gap-2 rounded-2xl bg-klein-600 px-4 py-2 text-sm font-semibold text-white transition-colors duration-200 hover:bg-klein-500"
            >
      ...
      <div className="mt-5 space-y-5">
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900">
              <div className="flex items-center gap-2 text-sm font-semibold text-slate-900 dark:text-white">
                <MessageSquare className="h-4 w-4 text-klein-500" />
                {t('需求与续写')}
              </div>
              <textarea
                value={draftPrompt}
                ...
                className="mt-3 min-h-[180px] w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm leading-8 text-slate-800 transition-colors duration-200 placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-klein-500/60 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500"
              />
              ...
              <button
                ...
                disabled={submitting}
                className="mt-4 inline-flex min-h-[48px] w-full cursor-pointer items-center justify-center gap-2 rounded-2xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition-colors duration-200 hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-klein-500 dark:hover:bg-klein-400"
              >
            ...
            {submitting ? (
              <div className="overflow-hidden rounded-2xl border border-emerald-500/20 bg-[linear-gradient(145deg,#0f172a,#111827)] p-4 shadow-xl dark:border-emerald-500/30">
                ...
                <pre className="mt-4 max-h-[420px] overflow-auto rounded-xl border border-white/5 bg-slate-950/80 p-4 text-xs leading-6 text-emerald-100">
                ...
                <button
                  ...
                  className={`w-full cursor-pointer rounded-2xl border px-4 py-3 text-left transition-colors duration-200 ${
                    activeSession?.id === session.id
                      ? 'border-klein-500 bg-klein-50 text-klein-950 dark:bg-klein-950/30 dark:text-klein-100'
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900 lg:p-5">
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:shadow-none">
            <iframe
      ...
      {isFullscreenOpen ? (
        ...
        >
          <div
            className="flex h-full w-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900"
