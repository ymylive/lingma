...
import { lessons } from '../data/lesson-content';
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {relatedExercises.map((exercise) => (
                    <div
                      ...
                      className="group cursor-pointer rounded-xl border border-indigo-100 bg-indigo-50 p-4 transition-all hover:border-indigo-300 hover:shadow-sm dark:border-indigo-900/50 dark:bg-indigo-900/20 dark:hover:border-indigo-500"
                    >
