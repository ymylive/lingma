...
export default function AlgorithmDetail() {
  ...
  if (!info) {
    return (
      <div className="page-safe-top min-h-screen bg-slate-50 px-4 transition-colors duration-300 dark:bg-slate-900 sm:px-6">
  ...
  return (
    <div className="page-safe-top min-h-screen bg-slate-50 pb-12 transition-colors duration-300 dark:bg-slate-900">
